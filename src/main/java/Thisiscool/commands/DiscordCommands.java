...
public class DiscordCommands {
    ...
    public static void load() {
        ...
        discordHandler.<MessageContext>register("unkick", "<server> <player...>", "unkick a player.", (args, context) -> {
            if (noRole(context, discordConfig.adminRoleIDs)) return;
        ...
        discordHandler.<MessageContext>register("stats", "<player...>", "Look up a player stats.", (args, context) -> {
            ...
            context.info(embed -> embed
                    ...
                    .addField("Wins:", Strings.format("""
                            ...
                            - HungerGames: @
                            - PvP: @
                            """, data.attackWins, data.TowerdefenseWins, data.FootballWins, data.hexedWins, data.msgoWins, data.pvpWins), false)
